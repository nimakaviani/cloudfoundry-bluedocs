...
var deflater = window.SharedWorker && new SharedWorker('../assets/rawdeflate.js');
if (deflater) {
  deflater.port.addEventListener('message', done_deflating, false);
  deflater.port.start();
} else if (window.Worker) {
  deflater = new Worker('../assets/rawdeflate.js');
...
$("img").each(function () {
  ...
  svgObj.setAttribute("style", "overflow:hidden;width:100%;margin-bottom:0;margin-top:0;padding:50px 15px 0px 15px;")
